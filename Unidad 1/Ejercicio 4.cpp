...
int main() {
    ...
    cout << "Porcentaje con hypotenusas > 100: " << cantHyp100/cantTriangulos*100 << endl;// se podría usar static_cast<double> pero no lo vimos
    cout << "Promedio de las medidas de las hipotenusas: " << sumHyp/cantTriangulos << endl;
    cout << "porcentaje con hipotenusa <= 100: " << (cantTriangulos - cantHyp100) / cantTriangulos * 100 << endl;
    return 0;
}
