@echo off
REM clang++ -std=c++23 -Wall -Wextra -Wpedantic -O3 -DNDEBUG ./src/build.cpp -o build.exe
...
clang++ -std=c++23 -Wall -Wextra -Wpedantic -g -O0 -DDEBUG ./src/formatear.cpp -o f.exe
